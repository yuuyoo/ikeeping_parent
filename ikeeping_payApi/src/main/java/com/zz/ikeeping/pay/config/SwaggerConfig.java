...
public class SwaggerConfig {
    ...
    public ApiInfo createA(){
        ApiInfo info=new ApiInfoBuilder().title("统一支付管理平台").
                contact( new Contact("DJL","","yuuyoo@163.com")).
                description("实现支付功能").build();
        return info;
    }
    /**
     * 创建API应用
    ...
    public Docket createDocket(){
       Docket docket=new Docket(DocumentationType.SWAGGER_2).apiInfo(createA()).select().
               apis(RequestHandlerSelectors.basePackage("com.zz.ikeeping.pay.controller")).
               build();
       return docket;
    }
}